...
def test_체크한것만_산다():
    결과 = parse_approvals(
        시트(
            ["A2026-08-19|005930", "2026-08-19", "005930", "삼성전자", "s", "10", "70000", "Y", ""],
            ["A2026-08-19|000660", "2026-08-19", "000660", "하이닉스", "s", "3", "200000", "", ""],
        ),
        오늘,
        ["005930", "000660"],
    )
...
def test_빈칸과_오타는_전부_거부다():
    for 값 in ("", " ", "N", "아마도", "?", "0"):
        결과 = parse_approvals(
            시트(["A2026-08-19|005930", "2026-08-19", "005930", "삼성", "s", "1", "1", 값, ""]),
            오늘,
            ["005930"],
        )
...
def test_어제_승인은_오늘_못쓴다():
    ...
    결과 = parse_approvals(
        시트(["A2026-08-18|005930", "2026-08-18", "005930", "삼성", "s", "1", "1", "Y", ""]),
        오늘,
        ["005930"],
    )
    assert 결과.승인된것 == ()
